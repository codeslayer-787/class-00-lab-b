...
//In this case, `this` is supposed to be inherited from the parent scope which seems to be global and undefined.

// 2. What is "this" when joe.scopeArrow() is invoked?
//I ran into a similar problem here...  it seems like `this` is global and undefined.  

// 3. Explain why "this" is different when an arrow function is used.
//`this` in an arrow function refers to the parent scope (whatever object that defined the arrow function).  Arrow functions do not bind their own `this`.  Normal functions use `this` to represent something in the object that called the function.  
